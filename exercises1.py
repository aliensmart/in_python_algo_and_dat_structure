...
# C-1.28 The p-norm of a vector v = (v 1 , v 2 , . . . , v n ) in n-dimensional space is de-   ========VIEW BOOK PAGE 53======
# fined as
# 
# p
# v = v 1 p + v 2 p + · · · + v n p .
